<x-guest-layout>
  <form method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
    ...
    <div class="mt-4">
      ...
      <x-text-input id="details" class="block mt-1 w-full" type="text" name="details" :value="old('details') ?? $product->details" required />
    ...
    <div class="mt-4">
      ...
      <x-text-input id="shipping_cost" class="block mt-1 w-full" type="text" name="shipping_cost" :value="old('shippingCost') ?? $product->shipping_cost"
        required />
    ...
    <div class="mt-4">
      ...
      <x-text-input id="description" class="block mt-1 w-full" type="text" name="description" :value="old('description') ?? $product->description"
        required />
